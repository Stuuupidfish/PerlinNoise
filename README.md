...
## Sources / Tech Stack
I used [Zipped's perlin noise tutorial](https://www.youtube.com/watch?v=kCIaHqb60Cw) to make this and basically translated his C++ code into a Java version (I left out contrast). His code can be found [here](https://pastebin.com/gXEYsmw8).
...
Obviously I used Java Math for the math.
